"""
================================================================================
MINDSET EMPLOYMENT ESTIMATION (synthetic data)
================================================================================
...
print("="*80)
print("MINDSET EMPLOYMENT ESTIMATION")
print("="*80)
...
Example: $1M "Transformation X Investment"
...
R:
    vectors <- list(
        ...
        "transf_2" = c(0.10, 0.25, 0.45, 0.15, 0.05)
    )

Python:
    vectors = {
        "roads": np.array([0.05, 0.30, 0.40, 0.20, 0.05]),
        "transf_2": np.array([0.10, 0.25, 0.45, 0.15, 0.05])
    }
...
transformation_vectors = {
    "infrastructure": np.array([0.05, 0.30, 0.40, 0.20, 0.05]),  
    "transf_2": np.array([0.10, 0.25, 0.45, 0.15, 0.05]),         
    "transf_3": np.array([0.08, 0.22, 0.35, 0.30, 0.05]),       
    "transf_4": np.array([0.02, 0.25, 0.30, 0.15, 0.28]),  
    "transf_5": np.array([0.00, 0.00, 1.00, 0.00, 0.00]) 
}
...
3. Compare scenarios (roads vs transf_2 vs transf_3)
