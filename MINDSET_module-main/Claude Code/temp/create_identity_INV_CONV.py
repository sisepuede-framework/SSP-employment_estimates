"""
Create a TRUE identity INV_CONV matrix for SSP aggregated data
...
print("="*80)
print("Creating Identity INV_CONV Matrix")
print("="*80)
print()
...
# Save to SSP folder
output_path = "GLORIA_db/v57/2019/SSP/INV_CONV.xlsx"
inv_conv_identity.to_excel(output_path, index=False)
...
verify = pd.read_excel(output_path)
